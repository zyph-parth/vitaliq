'use client'
// app/foods/page.tsx — Nutrient Explorer (redirect target from /nutrients)
  ...
  return (
    <AppShell>
      ...
      <section className="px-4 pb-6 pt-2 lg:px-0 lg:pt-2">
        <div className="overflow-hidden rounded-[32px] border border-white/70 bg-[linear-gradient(140deg,#f0fdf4_0%,#fafaf7_46%,#fef9ec_100%)] px-6 py-6 shadow-[0_20px_60px_rgba(15,23,42,0.08)] lg:px-8 lg:py-8">
          ...
          <p className="mt-4 max-w-xl text-sm leading-7 text-[#4b5563] sm:text-[15px]">
            Quick nutritional facts for everyday Indian &amp; global foods. Tap any food to see its full macro breakdown.
          </p>
        </div>
      </section>
          ...
          <button key={c.value} onClick={() => setCat(c.value)}
            className={clsx(
              ...
              cat === c.value
                ...
                : 'border-[#E8E8E3] bg-white text-[#8A8A85] hover:border-[#1A1A1A]'
            )}
          >
            {c.label}
          </button>
